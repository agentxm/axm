...
import { InstallMethodLiteral } from "../../../domain/index.js";
...
export interface InstallMetaService {
  ...
  readonly write: (data: InstallMetaData) => Effect.Effect<void, UpgradeFailed>;
}
...
export class InstallMeta extends ServiceMap.Service<InstallMeta, InstallMetaService>()(
  "axm.sh/install-meta/install-meta/InstallMeta",
) {}
