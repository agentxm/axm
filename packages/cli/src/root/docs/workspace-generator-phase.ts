...
import { renderWorkspaceGeneratorRegions } from "@agentxm/client-core/unstable/docs";
...
export const runDocsWorkspaceGeneratorPhase = Effect.fn("Docs.runDocsWorkspaceGeneratorPhase")(
