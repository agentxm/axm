...
and the existing mise-based workspace setup on native hosted runners. Git
secret detection is a separate required check alongside source and artifact
verification. Neither the scan nor its Git-state observations are cached by Nx.
