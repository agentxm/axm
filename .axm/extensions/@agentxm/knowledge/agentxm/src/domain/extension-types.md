...
The AgentXM extension model defines seven canonical extension types: six
non-pack types plus one container type.[^axm-readme] Each type has a singular canonical
...
| `pack`       | Packs         | A curated bundle referencing multiple non-pack extensions. See [Pack semantics](pack-semantics.md).                                                                                   |
