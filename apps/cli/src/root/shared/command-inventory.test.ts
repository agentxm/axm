...
} from "../../test-support/parser-cardinality.js";

/**
 * The command inventory agrees with rendered-help signatures and reviewed
 * parser occurrence cardinality, and routes each command and parameter to
 * applicable canonical specifications or explicit unresolved scope.
 *
 * Supersedes the retired specification identity
 * `system/process/command-inventory-routes-to-obligations`
