        ...
        return [
          {
            ...
            message: `Could not read settings.json: ${error.message}`,
            suggestions: [
              "Fix the JSON syntax error reported at the location above.",
              "Verify .axm/settings.json is valid JSON (quoted keys, no trailing commas).",
            ],
