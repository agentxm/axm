...
import { at, extensionName, handle, makeTestWorkspaceCatalog } from "./test-helpers.js";
...
const makeWorkspaceLayer = (sources: ReadonlyArray<ConfiguredSourceHost> = BUILT_IN_SOURCES) =>
  Layer.merge(
    makeTestWorkspaceCatalog({ sources }),
