...
describe("source-parser", () => {
  ...
  describe("prefixed shorthand", () => {
    ...
    it.effect("parses gitlab:owner/repo", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("gitlab:owner/repo");
    ...
    it.effect("parses github:owner/repo/path@ref", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("github:owner/repo/skills/my-skill@v1.0.0");
    ...
    it.effect("parses gitlab:owner/repo@ref", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("gitlab:owner/repo@main");
  ...
  describe("GitHub HTTPS URLs", () => {
    it.effect("parses https://github.com/owner/repo", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://github.com/owner/repo");
    ...
    it.effect("parses https://github.com/owner/repo.git", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://github.com/owner/repo.git");
    ...
    it.effect("parses https://github.com/owner/repo/tree/branch", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://github.com/owner/repo/tree/main");
    ...
    it.effect("parses https://github.com/owner/repo/tree/branch/path", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput(
    ...
    it.effect("parses http://github.com/owner/repo (HTTP)", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("http://github.com/owner/repo");
  ...
  describe("GitLab HTTPS URLs", () => {
    it.effect("parses https://gitlab.com/owner/repo", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://gitlab.com/owner/repo");
    ...
    it.effect("parses https://gitlab.com/owner/repo.git", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://gitlab.com/owner/repo.git");
    ...
    it.effect("parses https://gitlab.com/owner/repo/-/tree/branch", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://gitlab.com/owner/repo/-/tree/main");
  ...
  describe("GitHub SSH URLs", () => {
    it.effect("parses git@github.com:owner/repo.git", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@github.com:owner/repo.git");
    ...
    it.effect("parses git@github.com:owner/repo (without .git)", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@github.com:owner/repo");
  ...
  describe("GitLab SSH URLs", () => {
    it.effect("parses git@gitlab.com:owner/repo.git", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@gitlab.com:owner/repo.git");
    ...
    it.effect("parses git@gitlab.com:owner/repo (without .git)", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@gitlab.com:owner/repo");
  ...
  describe("Bitbucket HTTPS URLs", () => {
    it.effect("parses https://bitbucket.org/owner/repo", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://bitbucket.org/owner/repo");
    ...
    it.effect("parses https://bitbucket.org/owner/repo.git", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://bitbucket.org/owner/repo.git");
    ...
    it.effect("parses https://bitbucket.org/owner/repo/src/main", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://bitbucket.org/owner/repo/src/main");
  ...
  describe("Bitbucket SSH URLs", () => {
    it.effect("parses git@bitbucket.org:owner/repo.git", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@bitbucket.org:owner/repo.git");
    ...
    it.effect("parses git@bitbucket.org:owner/repo (without .git)", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@bitbucket.org:owner/repo");
  ...
  describe("Azure Repos HTTPS URLs", () => {
    it.effect("parses https://dev.azure.com/org/project/_git/repo", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("https://dev.azure.com/myorg/myproject/_git/myrepo");
    ...
    it.effect("parses http://dev.azure.com/org/project/_git/repo (HTTP)", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("http://dev.azure.com/myorg/myproject/_git/myrepo");
  ...
  describe("Azure Repos SSH URLs", () => {
    ...
    it.effect("parses git@ssh.dev.azure.com:v3/org/project/repo (without .git)", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("git@ssh.dev.azure.com:v3/myorg/myproject/myrepo");
  ...
  describe("Bitbucket shorthand", () => {
    it.effect("parses bitbucket:owner/repo", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("bitbucket:owner/repo");
    ...
    it.effect("parses bitbucket:owner/repo@ref", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("bitbucket:owner/repo@v1.0.0");
    ...
    it.effect("parses bitbucket:owner/repo/path@ref", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("bitbucket:owner/repo/skills/my-skill@main");
  ...
  describe("local path parsing", () => {
    it.effect("parses relative path starting with ./", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("./my-skill");
    ...
    it.effect("parses relative path starting with ../", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("../sibling-skill");
        expect(result.source).toBe("local");
    ...
    it.effect("parses absolute POSIX path", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("/home/user/skills/my-skill");
        expect(result.source).toBe("local");
    ...
    it.effect("parses home directory path with ~/", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("~/my-skills/dev-skill");
        expect(result.source).toBe("local");
    ...
    it.effect("parses Windows path with drive letter and backslash", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("C:\\Users\\name\\skills");
        expect(result.source).toBe("local");
    ...
    it.effect("parses Windows path with drive letter and forward slash", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("C:/Users/name/skills");
        expect(result.source).toBe("local");
    ...
    it.effect("fails on local: prefix (no shorthand)", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("local:./my-skill"));
        expect(error).toBeInstanceOf(ParseError);
      }),
    );
  });
  ...
  describe("unsupported URLs", () => {
    it.effect("fails on unknown HTTPS URLs", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("https://example.com"));
  ...
  describe("error handling", () => {
    ...
    it.effect("fails on name input (not yet supported)", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("not-a-valid-source"));
    ...
    it.effect("includes input in error", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("invalid"));
  ...
  describe("edge cases", () => {
    ...
    it.effect("rejects repo names with dots (use prefixed form)", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("owner/repo.js"));
        expect(error).toBeInstanceOf(ParseError);
...
describe("parseInputPattern", () => {
  ...
  describe("parseSourceInput pattern handling", () => {
    ...
    it.effect("fails with 'not yet supported' for NameInput", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("some-name"));
        expect(error).toBeInstanceOf(ParseError);
        expect(error.message).toBe("Name input is not yet supported");
      }),
    );
    ...
    it.effect("fails with 'not yet supported' for RegistryPatternInput", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("@myorg/some-name"));
        expect(error).toBeInstanceOf(ParseError);
    ...
    it.effect("fails for unsupported SCP host", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("git@example.com:owner/repo.git"));
        expect(error).toBeInstanceOf(ParseError);
    ...
    it.effect("fails for unsupported URL host", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("https://example.com/owner/repo"));
        expect(error).toBeInstanceOf(ParseError);
        expect(error.message).toContain("Unsupported URL host");
      }),
    );
    ...
    it.effect("rejects invalid URL with unrecognized segments", () =>
      Effect.gen(function* () {
        const error = yield* Effect.flip(parseSourceInput("http://"));
        expect(error).toBeInstanceOf(ParseError);
        expect(error.message).toBe("Unable to parse source");
      }),
    );
    ...
    it.effect("parses FilePathPattern via parseLocalPath", () =>
      Effect.gen(function* () {
        const result = yield* parseSourceInput("./local/path");
        expect(result.source).toBe("local");
    ...
    describe("ShorthandInput resolution", () => {
      ...
      it.effect("resolves bitbucket:owner/repo/path@ref to Bitbucket source", () =>
        Effect.gen(function* () {
          const result = yield* parseSourceInput("bitbucket:owner/repo/skills/my-skill@v1.0.0");
          expect(result).toMatchObject({
            source: "bitbucket",
            owner: "owner",
            repo: "repo",
