...
import { CredentialStoreTest } from "../credentials/credential-store.js";
import { withAuthGuard } from "./guard.js";
import { RegistryAccessFailed } from "./errors.js";
import { CredentialFileSchema } from "../credentials/schema.js";
...
describe("withAuthGuard", () => {
  ...
  it.effect("propagates inner effect errors", () => {
    ...
    return withAuthGuard(failingEffect).pipe(
      Effect.provide(layer),
      Effect.catchTag("RegistryAccessFailed", (e) =>
