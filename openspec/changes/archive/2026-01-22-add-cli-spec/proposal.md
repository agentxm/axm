...
The CLI package (`@axm.sh/cli`) needs a formal specification to define its expected behavior. The startup message exists but lacks a formal spec and proper test coverage.
