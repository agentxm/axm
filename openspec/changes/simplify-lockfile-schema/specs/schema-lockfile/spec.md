...
### Requirement: Nested source discriminated union

**Reason**: Replaced by flat schema with `source` string discriminator.

**Migration**: Use `source: "github"` with flat fields instead of `source: { _tag: "GitHub", ... }`.
