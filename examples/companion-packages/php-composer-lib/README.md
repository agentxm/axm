...
```json
{
  "extra": {
    "axm": {
      "recommendedExtensions": ["@examples/packs/php-composer-tinyflags@^0.1.0"]
    }
  }
}
```
...
| Type     | FQN                                                      |
| -------- | -------------------------------------------------------- |
| Skill    | `@examples/skills/php-composer-tinyflags-add-flag`       |
| Skill    | `@examples/skills/php-composer-tinyflags-rollout-review` |
| Skill    | `@examples/skills/php-composer-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/php-composer-tinyflags-maintainer`  |
| Pack     | `@examples/packs/php-composer-tinyflags`                 |
...
A working consumer is in `../php-composer-app/` (the `pawmatch` CLI).
