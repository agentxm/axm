...
`../npm-javascript-lib/.axm/extensions/` are designed to operate on.
...
[`npm-javascript-pawmatch-find-a-pet`](./.axm/extensions/@examples/skills/npm-javascript-pawmatch-find-a-pet/src/SKILL.md),
...
{
  "dependencies": {
    "@agentxm/example-tinyflags": "file:../npm-javascript-lib"
  }
}
```
