...
| Type     | FQN                                                        |
| -------- | ---------------------------------------------------------- |
| Skill    | `@examples/skills/javascript-npm-tinyflags-add-flag`       |
| Skill    | `@examples/skills/javascript-npm-tinyflags-rollout-review` |
| Skill    | `@examples/skills/javascript-npm-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/javascript-npm-tinyflags-maintainer`  |
| Pack     | `@examples/packs/javascript-npm-tinyflags`                 |

The pack bundles the three skills and the maintainer subagent. Each manifest
declares `pkg:npm/%40agentxm/example-tinyflags@0.1.0` as its companion package.

## Scenario

A working consumer is in `../javascript-npm-app/` (the `pawmatch` CLI).
