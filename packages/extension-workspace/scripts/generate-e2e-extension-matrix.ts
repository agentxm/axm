...
const source = `/**
 * @generated by extension-workspace:generate:e2e-extension-matrix (packages/extension-workspace/scripts/generate-e2e-extension-matrix.ts)
 * Source:     EXTENSION_TYPE_TABLE and the parity exemption ledger in packages/extension-workspace and packages/extension-model src
