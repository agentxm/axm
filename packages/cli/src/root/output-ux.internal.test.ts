...
const readQueryResultCallPattern =
  /\b(?:AgentCapabilitiesOutputSchema|AgentsListOutputSchema|CachePruneOutputSchema|CacheStatusOutputSchema|CacheVerifyOutputSchema|DiscoverOutputSchema|ExtensionInventorySchema|GrantListOutputSchema|HelpIndexResultSchema|HelpTopicResultSchema|InstructionsStatusOutputSchema|KnowledgeListQueryResultSchema|KnowledgeConceptCorpusChangingFailureSchema|KnowledgeConceptCursorFailureSchema|KnowledgeConceptQueryPageSchema|KnowledgeConceptGetOutputSchema|KnowledgeConceptResolveOutputSchema|KnowledgeConceptRelatedOutputSchema|KnowledgeConceptStatusOutputSchema|KnowledgeLintQueryResultSchema|LintResultDocumentSchema|ExtensionShowResultSchema|ExtensionListDocumentSchema|PackShowResultSchema|TokenDocumentSchema|TokenListDocumentSchema|ViewDocumentSchema|ViewFieldValueSchema|VisibilityEvaluationSchema|WhoamiDocumentSchema|WorkspaceStatusSchema)\b/;
