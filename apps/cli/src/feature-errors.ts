 ...
 * not render — lint staging, publishing, sharing, inspection, and Registry
 * access — into the CLI-facing `AppError` envelope. Every failure the kernel
 * renders projects through `app-error/conversions`.
 *
