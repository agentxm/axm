...
`../cargo-lib/.axm/extensions/` are designed to operate on.
...
[`cargo-pawmatch-find-a-pet`](./.axm/extensions/@examples/skills/cargo-pawmatch-find-a-pet/src/SKILL.md),
...
```toml
[dependencies]
agentxm-example-tinyflags = { path = "../cargo-lib", version = "0.1.0" }
```
