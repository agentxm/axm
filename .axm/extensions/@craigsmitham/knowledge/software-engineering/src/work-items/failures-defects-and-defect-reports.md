...
expectation. A **failure** is observed behavior that does not meet such an
expectation during execution. A **defect report** is the living work artifact
used to preserve and manage evidence of a suspected or confirmed discrepancy.
...
Observation, test result, review finding, alert, or reported occurrence
      ...
      confirmed   duplicate  expected   external      unresolved or
        defect               behavior     cause       more evidence needed
          │
          ├── correction, compensation, deferment, or accepted risk
          ▼
     resolution decision and resulting change
          │
          ▼
...
Defect report and classification
        ↕
Resolution decision and corrective change
        ↕
...
- there is no accepted expectation and someone seeks new behavior — record a
  [feature request](recording-feature-requests.md);
- only uncertainty reduction has been authorized — create an investigation;
- an accepted correction needs delivery planning — create the host's delivery
  item or task and retain the defect report as provenance; or
