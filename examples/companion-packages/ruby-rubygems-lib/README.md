...
```ruby
spec.metadata = {
  "axm_recommended_extensions" => "[@examples/packs/ruby-rubygems-tinyflags@^0.1.0]"
}
```
...
A working consumer is in `../ruby-rubygems-app/` (the `pawmatch` CLI).
...
| Type     | FQN                                                       |
| -------- | --------------------------------------------------------- |
| Skill    | `@examples/skills/ruby-rubygems-tinyflags-add-flag`       |
| Skill    | `@examples/skills/ruby-rubygems-tinyflags-rollout-review` |
| Skill    | `@examples/skills/ruby-rubygems-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/ruby-rubygems-tinyflags-maintainer`  |
| Pack     | `@examples/packs/ruby-rubygems-tinyflags`                 |
