...
/** @type {readonly Pet[]} */
export const ALL_PETS = Object.freeze([
  {
    slug: "biscuit",
    name: "Biscuit",
    species: "dog",
 ...
 * @returns {boolean}
 */
export function isLongStay(pet) {
 ...
 */
export function findPetBySlug(slug) {
 ...
 * @returns {readonly Pet[]}
 */
export function filterPetsBySpecies(species) {
  if (species == null) return ALL_PETS;
