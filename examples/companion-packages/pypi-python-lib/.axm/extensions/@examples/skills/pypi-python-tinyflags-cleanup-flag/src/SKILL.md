---
name: pypi-python-tinyflags-cleanup-flag
description: Remove a stale TinyFlags flag and simplify Python call sites.
---

# Cleanup TinyFlags Flag

Use this skill when a TinyFlags flag has reached its final treatment and should
be removed from a PyPI Python project.
...
3. Delete the flag entry from the `TinyFlags(...)` definition mapping.
...
- Keep type hints consistent with the package; prefer `from collections.abc
import Mapping` over `typing.Mapping` for new code.
