...
const registryPublishRejected = (args: {
...
const readExtensionIndex = (
  ...
  idxPath: string,
): Effect.Effect<ExtensionIndex, RegistryClientFailure> =>
  Effect.gen(function* () {
  ...
  previewExtensionPublishes: (args: PreviewExtensionPublishesArgs) =>
    Effect.gen(function* () {
      ...
      const candidates = yield* Effect.forEach(
        descriptors,
        (descriptor): Effect.Effect<PublicationCandidateResult, RegistryClientFailure> => {
