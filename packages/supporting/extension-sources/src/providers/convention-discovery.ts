...
import { SourceNotResolvable, type GitOperationFailed, type SourceError } from "../errors.js";
import {
...
const gitCommitShaFor = (basePath: string): Effect.Effect<string, GitOperationFailed> =>
