  ...
  describe("GitHub shorthand", () => {
    it.effect("parses owner/repo", () =>
      Effect.gen(function* () {
        ...
        expect(result.owner).toEqual(Option.some("owner"));
        expect(result.repo).toEqual(Option.some("repo"));
  ...
  describe("well-known URLs", () => {
    it.effect("parses https://example.com as wellknown", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("wellknown");
        expect(result.baseUrl).toEqual(Option.some("https://example.com"));
    ...
    it.effect("parses https://example.com/skills as wellknown", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("wellknown");
        expect(result.baseUrl).toEqual(Option.some("https://example.com/skills"));
      }),
    );
    ...
    it.effect("parses https://example.com/path/ as wellknown", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("wellknown");
        expect(result.baseUrl).toEqual(Option.some("https://example.com/path/"));
      }),
    );
    ...
    it.effect("parses http://localhost:3000 as wellknown", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("wellknown");
        expect(result.baseUrl).toEqual(Option.some("http://localhost:3000"));
      }),
    );
  });
  ...
  describe("edge cases", () => {
    ...
    it.effect("handles repo names with dots", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("github");
        expect(result.repo).toEqual(Option.some("repo.js"));
      }),
    );
    ...
    it.effect("handles repo names with dashes", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("github");
        expect(result.repo).toEqual(Option.some("my-awesome-repo"));
      }),
    );
    ...
    it.effect("handles owner names with dashes", () =>
      Effect.gen(function* () {
        ...
        expect(result.type).toBe("github");
        expect(result.owner).toEqual(Option.some("my-org"));
      }),
    );
