...
const readQueryResultCallPattern =
  /\b(?:AgentsListOutputSchema|DiscoverOutputSchema|HelpTopicResultSchema|HelpTopicsResultSchema|InstructionsStatusOutputSchema|LintJsonDocumentFields|OutdatedDocumentFields|TokenDocumentFields|TokenListDocumentFields|ViewDocumentFields|WhoamiDocumentFields|Schema\.Array\(Schema\.String\)|Schema\.String)\b/;
