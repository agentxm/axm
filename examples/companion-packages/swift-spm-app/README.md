...
skills and subagent in `../swift-spm-lib/.axm/extensions/` are designed to
operate on.
...
[`swift-spm-pawmatch-find-a-pet`](./.axm/extensions/@examples/skills/swift-spm-pawmatch-find-a-pet/src/SKILL.md),
...
`../swift-spm-lib/README.md` for the rationale.
