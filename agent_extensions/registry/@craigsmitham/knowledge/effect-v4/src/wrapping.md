...
sources:
  - id: effect-source
    ...
    title: Effect 4.0.0-rc.117 Effect source
  - id: applied-opencode
...
- [Effect interop constructors](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/packages/effect/src/Effect.ts)
