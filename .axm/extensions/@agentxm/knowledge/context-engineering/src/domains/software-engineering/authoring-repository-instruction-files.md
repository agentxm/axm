---
type: How-to Guide
title: How to author repository instruction files
description: How to create or revise a scoped repository instruction system without assuming one coding agent's loading or precedence behavior.
tags: [repository-instructions, authoring, agents.md, claude.md, scope, progressive-disclosure]
status: stable
generated: { by: "codex/gpt-5.6", at: 2026-08-15T20:45:15Z }
stale_after: 2027-02-15
sources:
  - id: repository-instruction-files
    resource: repository-instruction-files.md
    title: Repository instruction files
  - id: progressive-disclosure
    resource: ../../design/progressive-disclosure.md
    title: Progressive disclosure
---

# How to author repository instruction files

Use this guide to create or revise `AGENTS.md`, `CLAUDE.md`, or another
persistent repository instruction surface. It supplies a portable authoring
...
[audit finding classes](repository-instruction-files.md#audit-finding-classes)
