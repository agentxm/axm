...
- [ ] 2.2 Verify — run `pnpm typecheck && pnpm lint && pnpm test && pnpm test:e2e`, fix any failures
...
- [ ] 3.2 Verify — run `pnpm typecheck && pnpm lint && pnpm test && pnpm test:e2e`, fix any failures
- [ ] 3.3 Kill any vitest worker processes
...
- [ ] 5.2 Verify — run `pnpm typecheck && pnpm lint && pnpm test && pnpm test:e2e`, fix any failures
