...
export const PackManifestSchema = Schema.Struct({
  ...
  title: "Pack Manifest",
  description:
    "Extension manifest file for extension packs. Bundles a curated set of skills, commands, MCP servers, subagents, files, and rules into a single installable unit.",
});
