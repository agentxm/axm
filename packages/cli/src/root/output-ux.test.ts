...
const readQueryResultCallPattern =
  /\b(?:AgentsListOutputSchema|DiscoverOutputSchema|DoctorResultSchema|HelpTopicResultSchema|HelpTopicsResultSchema|InstructionsStatusOutputSchema|LintJsonDocumentFields|McpServerGetResultSchema|OutdatedDocumentFields|TokenDocumentFields|TokenListDocumentFields|ViewDocumentFields|WhoamiDocumentFields|Schema\.Array\(Schema\.String\)|Schema\.String)\b/;
