  ...
  capabilities: {
    ...
    subagent: {
      native: {
        ...
        vendorStatus: { state: "active" },
        notes:
          "Grok has built-in and config-defined parallel subagents, but no fixed user/project discovery directory that AXM's subagent model can materialize has been verified.",
        docs: [],
        sources: ["https://docs.x.ai/build/settings/reference"],
      },
      axm: {
        status: "unsupported",
        lastVerified: null,
