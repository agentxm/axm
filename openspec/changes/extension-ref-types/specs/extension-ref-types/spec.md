...
- **THEN** TypeScript narrows the ref to include `scope: string`, `name: string`, `version: string`, and `integrity: string` without type assertions
...
- Registry refs intersect with `RegistryRefDetails` (`scope: string`, `name: string`, `version: string`, `integrity: string`)
...
- **THEN** it has `type: "skill"`, `refType: "registry"`, `source: RegistrySource`, `skill: {...}`, `scope: string`, `name: string`, `version: string`, `integrity: string`
...
- **THEN** it has `type: "pack"`, `refType: "registry"`, `source: RegistrySource`, `pack: { name }`, `scope: string`, `name: string`, `version: string`, `integrity: string`
