...
- [Operate the merge queue](operate-merge-queue.md) — Enqueue accepted AXM changes, inspect synthesized verification, recover rejected entries, and verify or roll back the live GitHub integration gate.
