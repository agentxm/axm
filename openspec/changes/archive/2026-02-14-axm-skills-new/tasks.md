...
- [x] 3.1 Write `command.e2e.test.ts` covering: scaffolding a new skill end-to-end (directory structure, manifest content, SKILL.md content, settings entry, agent symlinks), already-exists error, scope flag override
...
- [x] 3.5 Run `pnpm test` to confirm no regressions
