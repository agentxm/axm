/**
 * context manifest schema definition.
 *
...
/**
 * Filename for context manifests.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const CONTEXT_MANIFEST_FILENAME = "context.json";

/**
 * Local directory segment for context packages under `.axm/extensions`.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const CONTEXT_EXTENSION_DIR = "context";

/**
 * URL for the context manifest JSON Schema.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const CONTEXT_MANIFEST_SCHEMA_URL = "https://axm.sh/schemas/context.schema.json";

/**
 * Scalar values accepted by context inputs and template substitution.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const FileInputValueSchema = Schema.Union([
  ...
  identifier: "ContextInputValue",
  title: "Context Input Value",
  description: "Scalar value used to render context templates.",
});
...
const FileInputStringDeclarationSchema = Schema.Struct({
  ...
  identifier: "ContextInputStringDeclaration",
  title: "Context Input String Declaration",
});
...
const FileInputNumberDeclarationSchema = Schema.Struct({
  ...
  identifier: "ContextInputNumberDeclaration",
  title: "Context Input Number Declaration",
});
...
const FileInputBooleanDeclarationSchema = Schema.Struct({
  ...
  identifier: "ContextInputBooleanDeclaration",
  title: "Context Input Boolean Declaration",
});
...
const FileInputEnumDeclarationSchema = Schema.Struct({
  ...
  identifier: "ContextInputEnumDeclaration",
  title: "Context Input Enum Declaration",
});
...
export const FileInputDeclarationSchema = Schema.Union([
  ...
  identifier: "ContextInputDeclaration",
  title: "Context Input Declaration",
  description: "A scalar input declaration for a context template.",
});
...
export const FileInputDeclarationsMapSchema = Schema.Record(
  ...
  identifier: "ContextInputDeclarationsMap",
  title: "Context Input Declarations Map",
});
...
export const FileGeneratorSpecSchema = Schema.Struct({
  ...
  identifier: "ContextGeneratorSpec",
  title: "Context Generator Spec",
...
const SourcePathSchema = Schema.Union([
  ...
  identifier: "ContextSourcePath",
  title: "Context Source Path",
...
/**
 * Content source for a context contents entry.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const FileContentSourceSchema = Schema.Union([
  ...
  identifier: "ContextContentSource",
  title: "Context Content Source",
...
/**
 * Materialization modes supported by context packages.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const FileMaterializationModeSchema = Schema.Literals([
  ...
  identifier: "ContextMaterializationMode",
  title: "Context Materialization Mode",
...
/**
 * One materialization target declared by context.json.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const FileContentsEntrySchema = Schema.Union([
  ...
  identifier: "ContextContentsEntry",
  title: "Context Contents Entry",
  description: "A context package content source and the workspace target it materializes into.",
});
...
/**
 * Schema for context manifest files (context.json).
 *
 * context packages distribute structural workspace files. They do not declare
 * agent compatibility.
 *
 * @experimental This API is unstable and may change without notice.
 */
export const ContextManifestSchema = Schema.Struct({
  $schema: Schema.optional(Schema.String),
  ...CommonManifestBaseFields,
  ...NonPackManifestFields,
  type: Schema.Literal("context"),
  name: ExtensionNameSchema.pipe(
    Schema.annotateKey({ messageMissingKey: "context package name is required" }),
    Schema.annotate({
      description:
        "Short name for this context package within its owner namespace. Combined with owner, forms the FQN @owner/context/<name>.",
    }),
  ),
  inputs: Schema.optional(FileInputDeclarationsMapSchema),
  contents: Schema.Array(FileContentsEntrySchema)
    .check(Schema.isMinLength(1))
    .pipe(Schema.annotateKey({ messageMissingKey: "context contents are required" })),
}).annotate({
  identifier: "ContextManifest",
  title: "Context Manifest",
  description:
    "context manifest for structural workspace file distribution. Declares payload sources, inputs, and materialization targets.",
});

/**
 * Inferred type for ContextManifest schema.
 *
 * @experimental This API is unstable and may change without notice.
 */
export type ContextManifest = Schema.Schema.Type<typeof ContextManifestSchema>;
