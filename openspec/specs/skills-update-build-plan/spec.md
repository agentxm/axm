# skills-update-build-plan Specification

## Purpose

Defines the update plan builder that compares installed skill versions against resolved sources and produces an execution plan.
