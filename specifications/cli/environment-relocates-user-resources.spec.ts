...
export const specification = defineSpecification({
  ...
  derivedFrom: [
    ...
    "packages/workspace-state/src/workspace/paths.test.ts",
    "packages/registry-auth/src/credential-store.test.ts",
    "packages/registry-auth/src/pending-device-login-store.test.ts",
    "packages/cli/src/install-meta/install-meta.test.ts",
  ],
  supersedes: [],
  assumptions: [],
  openQuestions: [
