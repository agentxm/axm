...
import type { FileAccessError, ContextAccessor } from "../../context.js";

export interface ContextAccessorPlatform {
...
export const makePlatformContextAccessor = (
  platform: ContextAccessorPlatform,
  absoluteRoot: string,
): ContextAccessor => {
