...
// resolves to source and the emitted matrix cannot drift behind stale dist output.
...
import { exemptedObligations } from "../src/extension-types/parity/exemptions.js";
import { EXTENSION_LIFECYCLE_CONTRACT } from "../src/extension-types/parity/lifecycle.js";
import { obligationsVerifiedBy } from "../src/extension-types/parity/obligations.js";
import {
...
const OUTPUT_PATH = path.join(
  CORE_ROOT,
  "../../../apps/cli-e2e/src/__generated__/extension-type-matrix.ts",
);
...
const source = `/**
 * @generated by extension-workspace:generate:e2e-extension-matrix (packages/core/extension-workspace/scripts/generate-e2e-extension-matrix.ts)
 * Source:     EXTENSION_TYPE_TABLE and the parity exemption ledger in packages/core/extension-workspace and packages/core/extension-model src
 * Regenerate: pnpm exec nx run extension-workspace:generate:e2e-extension-matrix
 * DO NOT EDIT - changes are overwritten on regeneration.
 *
 * Plain literals on purpose: apps/cli-e2e must not depend on
