...
`../composer-lib/.axm/extensions/` are designed to operate on.
...
[`composer-pawmatch-find-a-pet`](./.axm/extensions/@examples/skills/composer-pawmatch-find-a-pet/src/SKILL.md),
...
should be published from `../composer-lib/` first.
