...
import { renderWorkspaceGeneratorRegions } from "@agentxm/client-core/unstable/context-files";
...
export const runContextFilesWorkspaceGeneratorPhase = Effect.fn(
  "ContextFiles.runContextFilesWorkspaceGeneratorPhase",
