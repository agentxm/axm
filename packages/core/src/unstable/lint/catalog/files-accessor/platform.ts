...
import type { FileAccessError, FilesAccessor } from "../../context.js";

export interface FilesAccessorPlatform {
...
export const makePlatformFilesAccessor = (
  platform: FilesAccessorPlatform,
  absoluteRoot: string,
): FilesAccessor => {
