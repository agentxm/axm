...
```json
{
  "recommendedExtensions": ["@examples/packs/swift-spm-tinyflags@^0.1.0"]
}
```
...
A working consumer is in `../swift-spm-app/` (the `pawmatch` CLI).
...
| Type     | FQN                                                   |
| -------- | ----------------------------------------------------- |
| Skill    | `@examples/skills/swift-spm-tinyflags-add-flag`       |
| Skill    | `@examples/skills/swift-spm-tinyflags-rollout-review` |
| Skill    | `@examples/skills/swift-spm-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/swift-spm-tinyflags-maintainer`  |
| Pack     | `@examples/packs/swift-spm-tinyflags`                 |
