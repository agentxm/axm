...
```json
{
  "recommendedExtensions": ["@examples/packs/golang-tinyflags@^0.1.0"]
}
```
...
A working consumer is in `../golang-app/` (the `pawmatch` CLI).
...
| Type     | FQN                                                |
| -------- | -------------------------------------------------- |
| Skill    | `@examples/skills/golang-tinyflags-add-flag`       |
| Skill    | `@examples/skills/golang-tinyflags-rollout-review` |
| Skill    | `@examples/skills/golang-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/golang-tinyflags-maintainer`  |
| Pack     | `@examples/packs/golang-tinyflags`                 |
