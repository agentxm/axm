...
```toml
[tool.axm]
recommendedExtensions = ["@examples/packs/python-pypi-tinyflags@^0.1.0"]
```
...
A working consumer is in `../python-pypi-app/` (the `pawmatch` CLI).
...
| Type     | FQN                                                     |
| -------- | ------------------------------------------------------- |
| Skill    | `@examples/skills/python-pypi-tinyflags-add-flag`       |
| Skill    | `@examples/skills/python-pypi-tinyflags-rollout-review` |
| Skill    | `@examples/skills/python-pypi-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/python-pypi-tinyflags-maintainer`  |
| Pack     | `@examples/packs/python-pypi-tinyflags`                 |
