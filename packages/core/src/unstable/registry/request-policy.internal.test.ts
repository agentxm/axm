...
import { makeAppError, renderAppError } from "../app-error/index.js";
...
const mapError = (error: unknown) =>
  makeAppError({ code: "network", detail: "Registry request failed.", cause: error });
...
describe("executeRegistryRequest", () => {
  ...
  it.effect("maps a per-request timeout to a stable AppError", () =>
    Effect.gen(function* () {
