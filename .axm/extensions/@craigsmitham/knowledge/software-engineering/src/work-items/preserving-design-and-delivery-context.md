...
Use this guide when source material for a defect, feature request, or other
work item already contains technical investigation, design, planning, or test
detail. It governs faithful capture, not invention or approval of that detail.
...
detailed proposal without treating it as an accepted requirement.
