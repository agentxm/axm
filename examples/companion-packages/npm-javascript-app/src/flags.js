...
export function createPawMatchFlags() {
  return createFlags({
    ...
    [FLAG_PET_CARD_STYLE]: variantFlag(["compact", "detailed", "playful"], { default: "detailed" }),
    [FLAG_DONATE_FOCUS_DEFAULT]: variantFlag(["all", "shelters", "rescue"], { default: "all" }),
  });
}
