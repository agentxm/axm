---
name: dart-pub-pawmatch-find-a-pet
...
`pawmatch` CLI is available (run via `dart run pawmatch ...` or the compiled
executable). The skill drives `pawmatch` to surface candidates, explain
