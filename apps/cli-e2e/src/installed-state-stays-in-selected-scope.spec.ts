...
import {
  AgentsListDocument,
  InstructionsStatusDocument,
} from "./test-support/machine-documents.js";
...
export const specification = defineSpecification({
  ...
  derivedFrom: [
    ...
    "apps/cli/src/root/agents/add.ts",
    "apps/cli/src/root/agents/remove.ts",
    "apps/cli/src/root/instructions.ts",
    ...
    "apps/cli-e2e/src/activation-lifecycle.e2e.test.ts",
  ],
  supersedes: [],
  assumptions: [],
  openQuestions: [],
...
const decodeAgentScopeResult = Schema.decodeUnknownSync(
  Schema.Struct({ ok: Schema.Literal(true), result: AgentsListDocument }),
);
...
const decodeInstructionScopeResult = Schema.decodeUnknownSync(
  Schema.Struct({ ok: Schema.Literal(true), result: InstructionsStatusDocument }),
);
