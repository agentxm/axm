<!--
  Source: https://web.archive.org/web/20260116062223/https://code.claude.com/docs/en/slash-commands
  Retrieved: 2026-04-06

  Historical documentation on support for (now deprecated) Claude slash commands.
-->
...
| `context`                  | Set to `fork` to run the command in a forked subagent context with its own conversation history.                                                                                      | Inline (no fork)                    |
