...
import { exemptedObligations } from "../src/exemptions.js";
import { EXTENSION_LIFECYCLE_CONTRACT } from "../src/lifecycle.js";
import { obligationsVerifiedBy } from "../src/obligations.js";
import {
...
const source = `/**
 * @generated by extension-type-parity:generate:e2e-extension-matrix (tools/extension-type-parity/scripts/generate-e2e-extension-matrix.ts)
 * Source:     EXTENSION_TYPE_TABLE in packages/core/extension-model and the parity exemption ledger in tools/extension-type-parity
 * Regenerate: pnpm exec nx run extension-type-parity:generate:e2e-extension-matrix
