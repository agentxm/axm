...
const source = `/**
 * @generated by cli:generate:help-topics (apps/cli/scripts/generate-help-topics.ts)
 * Source:     apps/cli/help/topics/*.md and apps/cli/site-content/__generated__/schemas/*.schema.json
