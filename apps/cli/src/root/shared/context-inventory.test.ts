...
} from "../../test-support/command-inventory.js";
import {
  ...
  type ContextMember,
} from "../../test-support/context-inventory.js";

/**
 * The context inventory's declared finite populations agree with their named
 * authoritative sources, and its bindings identify canonical specification
 * owners with stated applicability, named interface authority, or explicit
 * unresolved scope.
 *
 * Supersedes the retired specification identity
 * `system/process/context-inventory-routes-to-obligations`
 * (see `specifications/disposition-ledger.json`): navigation metadata whose
 * only reader is the maintainer's own review.
 */
