...
export interface CodingAgent {
  ...
  ) => Effect.Effect<ResolveSkillsDirOutcome, ExtensionManagerFailure, Path.Path>;
...
>()("@agentxm/extension-workspace/extension-workspace/coding-agent/CodingAgentRepository") {}
