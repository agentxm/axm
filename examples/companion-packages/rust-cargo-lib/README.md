...
| Type     | FQN                                                    |
| -------- | ------------------------------------------------------ |
| Skill    | `@examples/skills/rust-cargo-tinyflags-add-flag`       |
| Skill    | `@examples/skills/rust-cargo-tinyflags-rollout-review` |
| Skill    | `@examples/skills/rust-cargo-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/rust-cargo-tinyflags-maintainer`  |
| Pack     | `@examples/packs/rust-cargo-tinyflags`                 |
