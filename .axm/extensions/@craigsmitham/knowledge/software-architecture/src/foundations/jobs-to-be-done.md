...
An architecture corpus should contain a job only when it preserves accepted,
...
architecture](capabilities.md) distinguishes demand-side jobs from
...
explains when to create `value/jobs/` and how to relate job documents to
the other architecture views. The [Software architecture docs application
profile for OKF v0.2](../architecture-documentation/software-architecture-application-profile.md)
...
Done](../guides/documenting-jobs-to-be-done.md) to create one maintained job
concept.
