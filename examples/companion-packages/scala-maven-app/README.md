...
`../scala-maven-lib/.axm/extensions/` are designed to operate on.
...
[`scala-maven-pawmatch-find-a-pet`](./.axm/extensions/@examples/skills/scala-maven-pawmatch-find-a-pet/src/SKILL.md),
...
```bash
mvn -q -f ../scala-maven-lib/pom.xml install
mvn -q package
