...
views, the [C4 model](c4-model.md) for runtime and code structure, and
[Reviewing responsibilities with
scenarios](../guides/reviewing-responsibilities-with-scenarios.md) to test
...
an OKF bundle, apply the [Software architecture docs application
profile](../architecture-documentation/software-architecture-application-profile.md)
for their types, metadata, paths, classification, and validation rules. The
profile defines author-facing cross-view relationship meanings while deferring
structured relationship frontmatter.

Use the focused guides for [subdomains](../guides/documenting-subdomains.md),
[bounded contexts](../guides/documenting-bounded-contexts.md), and [context
maps](../guides/documenting-context-maps.md) when authoring one artifact.
