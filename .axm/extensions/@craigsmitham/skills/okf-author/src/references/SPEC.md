<!--
Vendored copy. Do not edit — re-vendor instead.

  Source:    https://github.com/GoogleCloudPlatform/knowledge-catalog/blob/main/okf/SPEC.md
  Raw:       https://raw.githubusercontent.com/GoogleCloudPlatform/knowledge-catalog/<commit>/okf/SPEC.md
  Commit:    3fcbb9f828c2f23d109c855ee403c3a4c81f3a96 ("Update SPEC.md", 2026-07-24)
  Retrieved: 2026-07-27
  Spec:      OKF v0.2

To refresh: fetch the raw URL at the new commit, replace this file's body, and update
the commit/retrieved lines above plus the pin noted in ../SKILL.md.
-->
