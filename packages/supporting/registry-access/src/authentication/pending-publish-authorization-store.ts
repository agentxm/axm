...
export interface PendingPublishAuthorizationStoreService {
  readonly save: (
    pending: PendingPublishAuthorization,
  ) => Effect.Effect<void, RegistryAccessFailed>;
  readonly load: (
    requestRef: string,
  ) => Effect.Effect<Option.Option<PendingPublishAuthorization>, RegistryAccessFailed>;
  readonly clear: (requestRef: string) => Effect.Effect<void, RegistryAccessFailed>;
}
...
>()("@agentxm/registry-access/PendingPublishAuthorizationStore") {}
