 ...
 *
 * Usage:
 *   pnpm exec nx run extension-management:generate:telemetry-client
 */
...
const header = `/**
 * @generated by extension-management:generate:telemetry-client (openapigen)
 * Source:     packages/extension-management/specs/telemetry-openapi.json
 * Regenerate: pnpm exec nx run extension-management:generate:telemetry-client
