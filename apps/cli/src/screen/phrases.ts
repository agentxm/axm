 ...
 * make. Both numbers count attempts (including the first); a first attempt is
 * not a retry and says nothing.
 */
  ...
  switch (outcome) {
    ...
    case "no-op":
      return counts.total === 0
        ...
        : "Already up to date";
    case "partial":
      return `Partially ${presentation.verb.past.toLowerCase()}`;
    case "failed":
