...
11. **Record maintenance ownership.** Name owners for each scope, review
    triggers, unresolved host behavior, and any deeper artifact that still
    needs creation or repair.
12. **Handoff.** Summarize identities, changes, moved or retained routes,
...
points receive the intended effective context; and remaining uncertainty is
visible without claiming independent conformity.
