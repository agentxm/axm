...
sources:
  - id: effect-logging
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/ai-docs/src/08_observability/10_logging.ts
    title: Effect 4.0.0-rc.117 logging guide
  - id: effect-otlp
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/ai-docs/src/08_observability/20_otlp-tracing.ts
    title: Effect 4.0.0-rc.117 OTLP tracing guide
...
- [Logging guide](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/ai-docs/src/08_observability/10_logging.ts)
- [OTLP tracing guide](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/ai-docs/src/08_observability/20_otlp-tracing.ts)
