...
const cases: ReadonlyArray<ConversionCase> = [
  {
    ...
    code: "internal",
    detail: "Failed to recover an interrupted package installation at /w/pkg",
    cause: ioCause,
  },
  {
    ...
    code: "internal",
    detail: "Failed to prepare the package location for /w/pkg",
    cause: ioCause,
  },
  {
    ...
    code: "internal",
    detail: "Failed to prepare temporary package files at /w/pkg.axm-staging",
    cause: ioCause,
  },
  {
    ...
    code: "internal",
    detail: "Failed to inspect the installed package at /w/pkg",
    cause: ioCause,
  },
  {
    ...
    code: "internal",
    detail: "Failed to replace the installed package at /w/pkg",
    cause: ioCause,
  },
  {
  ...
  },
  {
    ...
    code: "internal",
    detail: "Installed files for rule demo could not be verified",
  },
  {
    name: "RuleInstallStateMissing content-identity",
    failure: new RuleInstallStateMissing({ name: "demo", kind: "content-identity" }),
    code: "internal",
    detail: "Installed content for rule demo could not be identified",
  },
  {
  ...
  },
  {
    ...
    code: "internal",
    detail: "Installed files for hook demo could not be verified",
  },
  {
    name: "HookInstallStateMissing content-identity",
    failure: new HookInstallStateMissing({ name: "demo", kind: "content-identity" }),
    code: "internal",
    detail: "Installed content for hook demo could not be identified",
  },
  {
  ...
  },
  {
    ...
    code: "internal",
    detail: "Installed content for subagent demo could not be identified",
  },
  {
    ...
    code: "internal",
    detail: "Subagent demo has no locked source",
  },
  {
    name: "McpInstallStateMissing",
    failure: new McpInstallStateMissing({ name: "demo" }),
    code: "internal",
    detail: "Installed files for MCP server demo could not be verified",
  },
  {
  ...
  },
  {
    ...
    code: "internal",
    detail: "Installed files for pack demo could not be verified",
  },
  {
  ...
  },
  {
    ...
    code: "internal",
    detail: "Installed files for Knowledge bundle demo could not be verified",
  },
  {
    ...
    code: "internal",
    detail: "Installed content for Knowledge bundle demo could not be identified",
  },
  {
    ...
    code: "internal",
    detail: "Prepared files for Knowledge bundle demo could not be verified",
  },
  {
    name: "KnowledgeResolutionMissing",
    failure: new KnowledgeResolutionMissing({ name: "demo" }),
    code: "conflict",
    detail: "AXM has no locked version for active Knowledge bundle demo",
  },
  {
