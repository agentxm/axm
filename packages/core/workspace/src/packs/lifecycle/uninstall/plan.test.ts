...
import { SetActivation } from "../../../lifecycle/activation/set-activation.js";
import {
  applyInstall,
  installRequest,
  makeInstallWorld,
...
import { UninstallExtensions } from "../../../lifecycle/uninstall/uninstall-extensions.js";
import {
  applyUninstall,
  previewUninstall,
  uninstallRequest,
} from "../../../lifecycle/uninstall/test-helpers.js";
import {
