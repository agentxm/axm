...
describe("parseFqn", () => {
  [
    ...
    {
      input: "@acme/context/project-rules",
      expected: { owner: "@acme", type: "context", name: "project-rules" },
    },
    {
...
describe("formatFqn", () => {
  ...
  it("formats all type segments correctly", () => {
    ...
    expect(formatFqn({ owner: handle("@x"), type: "context", name: extensionName("y") })).toBe(
      "@x/context/y",
    );
