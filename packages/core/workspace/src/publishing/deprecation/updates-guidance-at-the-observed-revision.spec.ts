  ...
  const cases = [
    {
      name: "new message",
      current: null,
      reason: Option.some("other" as const),
      message: Option.some("  New guidance.  "),
      replacement: Option.none<string>(),
      clearMessage: false,
      clearReplacement: false,
      expected: { reason: "other", message: "New guidance.", replacement: { kind: "clear" } },
    },
    {
      name: "replacement only",
      current: null,
      reason: Option.some("superseded" as const),
      ...
      expected: {
        reason: "superseded",
        message: null,
        replacement: { kind: "set", fqn: replacement },
      },
    },
    {
      name: "omitted message",
      current: { deprecatedAt, reason: "other", message: "Existing guidance." },
      reason: Option.none(),
      message: Option.none<string>(),
      replacement: Option.some(replacement),
      clearMessage: false,
    ...
    },
    {
      ...
      expected: { reason: "other", message: "Old guidance.", replacement: { kind: "clear" } },
    },
  ];
