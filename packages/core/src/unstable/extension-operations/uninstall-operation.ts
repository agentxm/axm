...
import type { ExtensionManager, ExtensionTargetFor } from "../workspace/service-interface.js";
import { type UninstallRetentionPolicy, toLabel } from "./install-operation.js";
