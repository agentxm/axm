...
const sourceRoots = ["apps/cli/src"] as const;
...
const readOnlyRendererResultFiles = new Set([
  "apps/cli/src/root/agents/list.ts",
  "apps/cli/src/root/auth/whoami.ts",
  "apps/cli/src/root/discover/handler.ts",
  "apps/cli/src/root/help/command.ts",
  "apps/cli/src/root/list/command.ts",
  "apps/cli/src/root/knowledge/concepts/failures.ts",
  "apps/cli/src/root/view/handler.ts",
]);
...
const planResultCallPattern =
  /\b(?:PlanResolutionDocumentSchema|PlanResolutionResultSchema|PublishResultSchema|SetupDocumentSchema|UpgradeDocumentSchema|LoginDocumentSchema|LoginNoOpDocumentSchema|DeviceLoginPendingDocumentSchema|LogoutDocumentSchema|RevokeTokenDocumentSchema|LintFixDocumentSchema|VisibilityMutationResultSchema|LifecycleTransitionOutputSchema)\b/;

const readQueryResultCallPattern =
  /\b(?:AgentCapabilitiesOutputSchema|AgentsListOutputSchema|CachePruneOutputSchema|CacheStatusOutputSchema|CacheVerifyOutputSchema|DiscoverOutputSchema|ExtensionInventorySchema|GrantListOutputSchema|HelpIndexResultSchema|HelpTopicResultSchema|InstructionsStatusOutputSchema|KnowledgeListQueryResultSchema|KnowledgeConceptCorpusChangingFailureSchema|KnowledgeConceptCursorFailureSchema|KnowledgeConceptQueryPageSchema|KnowledgeConceptGetOutputSchema|KnowledgeConceptResolveOutputSchema|KnowledgeConceptRelatedOutputSchema|KnowledgeConceptStatusOutputSchema|KnowledgeLintQueryResultSchema|LintResultDocumentSchema|McpServerListQueryResultSchema|ExtensionShowResultSchema|ExtensionListDocumentSchema|PackShowResultSchema|TokenListDocumentSchema|ViewDocumentSchema|ViewFieldValueSchema|VisibilityEvaluationSchema|WhoamiDocumentSchema|WorkspaceStatusSchema)\b/;
