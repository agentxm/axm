...
describe("registryGuard", () => {
  ...
  const makeWorkspaceLayer = (opts: {
    ...
    const mockWorkspace: WorkspaceContextService = {
      ...
      removeSkillLock: vi.fn(() => Effect.void),
      removeCommandSettings: vi.fn(() => Effect.void),
      removeCommandLock: vi.fn(() => Effect.void),
      removeMcpServerSettings: vi.fn(() => Effect.void),
      removeMcpServerLock: vi.fn(() => Effect.void),
      removePackSettings: vi.fn(() => Effect.void),
      removePackLock: vi.fn(() => Effect.void),
      isExtensionRequiredByInstalledPack: vi.fn(() => Effect.succeed(false)),
      markDependencyRetainedInLockfile: vi.fn(() => Effect.void),
