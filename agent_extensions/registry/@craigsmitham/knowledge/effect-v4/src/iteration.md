...
sources:
  - id: effect-source
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/packages/effect/src/Effect.ts
    title: Effect 4.0.0-rc.117 traversal and repetition source
  - id: effect-schedule
    resource: https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/packages/effect/src/Schedule.ts
    title: Effect 4.0.0-rc.117 Schedule source
...
- [Effect traversal and repetition source](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/packages/effect/src/Effect.ts)
- [Schedule source](https://github.com/Effect-TS/effect/blob/effect%404.0.0-rc.117/packages/effect/src/Schedule.ts)
