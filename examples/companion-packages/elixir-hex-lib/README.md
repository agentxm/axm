...
A working consumer is in `../elixir-hex-app/` (the `pawmatch` CLI).
...
| Type     | FQN                                                    |
| -------- | ------------------------------------------------------ |
| Skill    | `@examples/skills/elixir-hex-tinyflags-add-flag`       |
| Skill    | `@examples/skills/elixir-hex-tinyflags-rollout-review` |
| Skill    | `@examples/skills/elixir-hex-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/elixir-hex-tinyflags-maintainer`  |
| Pack     | `@examples/packs/elixir-hex-tinyflags`                 |
