...
Pack extension refs SHALL expose a canonical `owner` field. The owner SHALL be populated from the registry ref details. This owner is required for constructing pack extension targets used in uninstall operations.
