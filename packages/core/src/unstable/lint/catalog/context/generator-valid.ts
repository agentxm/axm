...
import { isFileIndexColumn } from "../../../context/generators.js";
import type { FileGeneratorSpec } from "../../../context/manifest-schema.js";
...
const RULE_ID = "context/generator-valid";
...
export const generatorValidRule: AdvisoryRule<ContextRuleContext> = {
  id: RULE_ID,
