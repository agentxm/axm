...
- **AND** SHALL materialize the `@axm.sh/cli` builtin pack skills into the workspace
...
- **AND** SHALL materialize the `@axm.sh/cli` builtin pack skills into the workspace after agent selection
