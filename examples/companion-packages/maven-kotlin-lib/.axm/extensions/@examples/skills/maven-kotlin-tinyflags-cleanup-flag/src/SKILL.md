---
name: maven-kotlin-tinyflags-cleanup-flag
description: Remove a stale TinyFlags flag and simplify Kotlin call sites.
---

# Cleanup TinyFlags Flag

Use this skill when a TinyFlags flag has reached its final treatment and
should be removed from a Maven Kotlin project.
...
5. Add or update Kotest specs for the final simplified behavior.
...
- Preserve public API compatibility unless release notes call out a
  breaking change.
- Keep Kotlin file ordering and `pom.xml` source roots intact.
