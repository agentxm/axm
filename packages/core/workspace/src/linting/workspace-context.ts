...
import type { CanonicalObservation, InstallRootInventory } from "../desired-state/index.js";
...
import type { LockfileReadError, SettingsReadError } from "../desired-state/index.js";
 ...
 */
export type WorkspaceHealthFailure = { readonly _tag: string };
