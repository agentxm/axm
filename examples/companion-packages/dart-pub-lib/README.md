...
A working consumer is in `../dart-pub-app/` (the `pawmatch` CLI).
...
| Type     | FQN                                                  |
| -------- | ---------------------------------------------------- |
| Skill    | `@examples/skills/dart-pub-tinyflags-add-flag`       |
| Skill    | `@examples/skills/dart-pub-tinyflags-rollout-review` |
| Skill    | `@examples/skills/dart-pub-tinyflags-cleanup-flag`   |
| Subagent | `@examples/subagents/dart-pub-tinyflags-maintainer`  |
| Pack     | `@examples/packs/dart-pub-tinyflags`                 |
